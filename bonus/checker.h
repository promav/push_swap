...
/*   Updated: 2024/09/24 11:49:30 by pabromer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				sort_3elements(t_list **x, t_list **c_x);
...
void			ft_swap_swap_ch(t_list **x, t_list **y, \
t_list **c_x, t_list **c_y);
void			ft_rotate_ch(t_list **list, t_list **c);
void			ft_rot_rot_ch(t_list **x, t_list **y, \
t_list **c_x, t_list **c_y);
void			ft_rrotate_ch(t_list **list, t_list **c);
void			ft_rrot_rrot_ch(t_list **x, t_list **y, \
t_list **c_x, t_list **c_y);
void			ft_push_ch(t_list **x, t_list **y, t_list **c_x, t_list **c_y);
void			ft_checker(t_list **x, t_list **y);
int				ft_valid_arg(int argc, char **argv);
int				ft_instruction_1(t_list **x, t_list **y, char *s);
int				ft_instruction_2(t_list **x, t_list **y, char *s);
void			ft_validator(t_list **x, int a);
#endif
